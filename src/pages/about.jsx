    ...
    return (
        <Layout
            ...
            <div className="blog-post">
                <h2 className="blog-post-title">{JSON.stringify(router.query)}</h2>
                <h2 className="blog-post-title">{JSON.stringify(router.params)}</h2>
                <h2 className="blog-post-title">{JSON.stringify(router.pathname)}</h2>
                <h2 className="blog-post-title">{JSON.stringify(router.asPath)}</h2>
